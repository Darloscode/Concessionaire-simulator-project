...
public class Supervisor extends Usuario{
    ...
    //Método para agrega las solicitudes de compras que son enviadas por el cliente
    public void agregarSolicitud(Vehiculo vh, Cliente cl){
        solicitudes.add(vh);
        clientes.add(cl);
    }

    //Método para visualizar todo el stock
    ...
    //Método que muestra las solicitudes de compras para que el supervisor las apruebe o rechaze
    //si son aceptadas el vehiculo será enviado a un jefe de taller
    //si son rechazadas deberá dar una razon, la cual será enviada al cliente
    ...
    //Método que envía el vehiculo al jefe de taller para que realice la entrega del vehiculo
